            ...
            <div className="mission-header-industrial">
                <div className="mission-header-left">
                    ...
                    <div className="mission-header-text">
                        <h3 className="mission-title-main">Tiáº¿n Äo™</h3>
                        <p className="mission-subtitle">Thử thách hà ng ngà y</p>
                    </div>
                </div>
                        ...
                        <div key={m.id} className={`mission-item ${isDone ? 'done' : ''}`}>
                            ...
                            {isDone && (
                                ...
                                >
                                    ...
                                    {m.claimed ? 'Äà£ nháº­n thưoŸng' : 'Nháº­n pháº§n thưoŸng'}
                                </button>
                            )}
                        </div>
                    )
            ...
            <div className={`prize-reveal-content ${claimedPrize ? 'titan-prize-zoom' : ''}`}>
                {claimedPrize ? (
                    <div className="prize-reveal-card">
                        ...
                        <p className="prize-type-label">{claimedPrize.type.toUpperCase()} THÆ¯ožNG</p>
                        <p className="prize-desc-text">Chàºc mừng báº¡n đã hoà n thà nh nhiệm vo¥ và  nháº­n Ä‘ưo£c pháº§n quà  nà y.</p>
                        <button className="btn btn-primary prize-close-btn" onClick={closeCelebration}>Äà“NG</button>
                    </div>
                ) : (
                    <div className="titan-chest-shake">
                        ...
                        <h3 className="celebration-sync-text">ÄANG Xo¬ Là PHáº¦N THÆ¯ožNG...</h3>
