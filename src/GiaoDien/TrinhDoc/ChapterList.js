    ...
    <section className="chapter-list-section fade-in">
      <div className="chapter-list-header-industrial">
        <h2 className="chapter-list-title-titan">
          DANH SàCH CHÆ¯Æ NG <span className="text-secondary-titan">({chapters?.length || 0})</span>
        </h2>
        ...
        <div className="chapter-list-actions-industrial">
            <button 
                ...
                aria-label={sortOrder === 'desc' ? 'Sắp xáº¿p cÅ© nháº¥t' : 'Sắp xáº¿p mo›i nháº¥t'}
            >
                <ArrowUpDown size={14} /> {sortOrder === 'desc' ? 'MỚI NHáº¤T' : 'CÅ¨ NHáº¤T'}
            </button>

            <div className="chapter-search-box-industrial">
              <input 
                type="text" 
                placeholder="Tà¬m nhanh chưÆ¡ng..." 
                value={searchTerm}
                autoComplete="off"
                className="chapter-search-input-industrial"
                aria-label="Tà¬m nhanh chưÆ¡ng"
                onChange={(e) => {
      ...
      {filteredChapters.length === 0 ? (
        <div className="empty-state-titan industrial-p-80">
            Khà´ng tà¬m tháº¥y chưÆ¡ng nà o phà¹ ho£p với từ khà³a của báº¡n.
        </div>
      ) : (
        <>
                                ...
                                <div className="chapter-badges-v2">
                                    {isLastRead && (
                                        <span className="badge-history-titan">
                                            <Navigation size={10} fill="currentColor" /> Láº¦N ÄoŒC CUoI
                                        </span>
                                    )}
                                    {isGhost && (
                                        <span className="badge-ghost-v2">
                                            <Ghost size={12} /> Lo–I NGUỒN
                                        </span>
                                    )}
