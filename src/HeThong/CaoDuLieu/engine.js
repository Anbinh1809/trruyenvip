...
import { query, withTransaction, bulkInsert, loadSystemState } from '../Database/CoSoDuLieu.js';
...
// Concurrency State
let activeWorkers = 0;
const BASE_CONCURRENCY = 10; // POLARIS-GRADE: Stabilized for server health
...
export async function crawlFullMangaChapters(mangaId, url, source, earlyExit = false) {
    ...
    try {
        ...
        const CHUNK_SIZE = 5; // Polished batch size for DB stability and mirror safety
