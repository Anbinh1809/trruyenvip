    ...
    <section className="checkin-section-titan fade-up">
        <div className="glass-titan-checkin">
            <div className="checkin-info-industrial">
                <h3 className="checkin-title">Đio�m danh hằng ng�y</h3>
                <p className="checkin-subtitle">Nhận VipCoins v� XP mo�i lần b�o danh.</p>
            ...
            <div className="checkin-action">
                ...
                >
                    {alreadyChecked ? 'Đ� đio�m danh' : 'Đio�m danh ngay'}
                </button>
